...
xcopy ..\CadmusBricks\Cadmus.Refs.Bricks\bin\Debug\net9.0\*.* %target%\Cadmus.Tgr.Services\ /y
...
xcopy ..\CadmusBricks\Cadmus.Refs.Bricks\bin\Debug\net9.0\*.* %target%\Cadmus.Vela.Services\ /y
