...
xcopy ..\CadmusBricks\Cadmus.Refs.Bricks\bin\Debug\net10.0\*.* %target%\Cadmus.Tgr.Services\ /y
...
xcopy ..\CadmusBricks\Cadmus.Refs.Bricks\bin\Debug\net10.0\*.* %target%\Cadmus.Vela.Services\ /y
